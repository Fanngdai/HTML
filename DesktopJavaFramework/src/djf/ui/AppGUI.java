...
public class AppGUI {
    ...
    // cut, copy & paste button homework1
    ...
    private void initTopToolbar(AppTemplate app) {
        ...
        // Put the buttons in the toolbar Homework1
        cutButton = initChildButton(fileToolbar, CUT_ICON.toString(), CUT_TOOLTIP.toString(), true);
        copyButton = initChildButton(fileToolbar, COPY_ICON.toString(), COPY_TOOLTIP.toString(), true);
        pasteButton = initChildButton(fileToolbar, PASTE_ICON.toString(), PASTE_TOOLTIP.toString(), true);
